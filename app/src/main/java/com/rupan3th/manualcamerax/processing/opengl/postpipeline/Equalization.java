...
import com.rupan3th.manualcamerax.processing.opengl.postpipeline.dngprocessor.Histogram;
import com.rupan3th.manualcamerax.processing.render.Converter;
import com.rupan3th.manualcamerax.util.FileManager;
import com.rupan3th.manualcamerax.util.SplineInterpolator;
...
import static com.rupan3th.manualcamerax.util.Math.MirrorCoords;
import static com.rupan3th.manualcamerax.util.Math.mix;
...
public class Equalization extends Node {
    ...
    private Histogram Analyze(){
        ...
        if(customAnalyzelut.exists()){
            ...
            analyze_lutbm = BitmapFactory.decodeResource(ManualCameraX.getResourcesStatic(),R.drawable.analyze_lut);
            analyze_lut = new GLTexture(analyze_lutbm,GL_LINEAR,GL_CLAMP_TO_EDGE,0);
        }
    ...
    private float findWL(float[] input){
        boolean nightMode = ManualCameraX.getSettings().selectedMode == CameraMode.NIGHT;
