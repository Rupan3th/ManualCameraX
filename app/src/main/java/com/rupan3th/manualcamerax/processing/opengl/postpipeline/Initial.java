...
import com.rupan3th.manualcamerax.processing.render.ColorCorrectionTransform;
...
public class Initial extends Node {
    ...
    public void Run() {
        ...
        if(customlut.exists()){
            ...
            lutbm = BitmapFactory.decodeResource(ManualCameraX.getResourcesStatic(),R.drawable.initial_lut);
        }
