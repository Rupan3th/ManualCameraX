package com.rupan3th.manualcamerax.processing.render;
...
public class Parameters {
    ...
    public void FillConstParameters(CameraCharacteristics characteristics, Point size) {
        ...
        tonemapStrength = (float) ManualCameraX.getSettings().compressor;
        ...
        if (ManualCameraX.getSettings().cfaPattern >= 0) {
            cfaPattern = (byte) ManualCameraX.getSettings().cfaPattern;
        }
    ...
    public void ReCalcColor(boolean customNeutr) {
        ...
        ColorSpaceTransform CST = ManualCameraX.getCaptureController().mColorSpaceTransform;//= result.get(CaptureResult.COLOR_CORRECTION_TRANSFORM);
        ...
        if(ManualCameraX.getSpecific().isRawColorCorrection) wrongCalibration = false;
    ...
    public String toString() {
        return "parameters:\n" +
                ...
                "\n CameraID=" + ManualCameraX.getSettings().mCameraID +
                "\n Sat=" + FltFormat(PreferenceKeys.getSaturationValue()) +
                "\n Shadows=" + FltFormat(ManualCameraX.getSettings().shadows) +
                ...
                "\n DenoiseOn=" + ManualCameraX.getSettings().hdrxNR +
                "\n FocalL=" + FltFormat(focalLength) +
                "\n Version=" + ManualCameraX.getVersion();
    }
