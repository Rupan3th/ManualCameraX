package com.rupan3th.manualcamerax.processing.opengl;
...
public class GLUtils {
    ...
    public void bluxVH(GLTexture in,GLTexture out, double size,boolean horizontal){
        ...
        glProg.useProgram(ManualCameraX.getAssetLoader().getString("blurvh.glsl"));
        glProg.setTexture("InputBuffer",in);
    ...
    public void Corners(GLTexture dxy,GLTexture out){
        ...
        glProg.useProgram(ManualCameraX.getAssetLoader().getString("corners.glsl"));
    ...
    public void ConvDiff(GLTexture in, GLTexture out, float gradientShift, float rotation){
        ...
        glProg.useProgram(ManualCameraX.getAssetLoader().getString("convdiff.glsl"));
    ...
    public void Maximaze(GLTexture in,GLTexture in2, GLTexture out){
        ...
        glProg.useProgram(ManualCameraX.getAssetLoader().getString("maximaze.glsl"));
        glProg.setTexture("InputBuffer",in);
