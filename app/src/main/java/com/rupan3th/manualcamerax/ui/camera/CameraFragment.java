...
import com.rupan3th.manualcamerax.control.CountdownTimer;
import com.rupan3th.manualcamerax.control.Swipe;
import com.rupan3th.manualcamerax.control.TouchFocus;
import com.rupan3th.manualcamerax.databinding.CameraFragmentBinding;
import com.rupan3th.manualcamerax.databinding.LayoutBottombuttonsBinding;
import com.rupan3th.manualcamerax.databinding.LayoutMainTopbarBinding;
import com.rupan3th.manualcamerax.gallery.ui.GalleryActivity;
...
import com.rupan3th.manualcamerax.settings.SettingType;
...
import com.rupan3th.manualcamerax.ui.camera.model.TopBarSettingsData;
import com.rupan3th.manualcamerax.ui.camera.viewmodel.AuxButtonsViewModel;
import com.rupan3th.manualcamerax.ui.camera.viewmodel.CameraFragmentViewModel;
import com.rupan3th.manualcamerax.ui.camera.viewmodel.SettingsBarEntryProvider;
...
import com.rupan3th.manualcamerax.ui.camera.views.FlashButton;
import com.rupan3th.manualcamerax.ui.camera.views.TimerButton;
import com.rupan3th.manualcamerax.ui.camera.views.modeswitcher.wefika.horizontalpicker.HorizontalPicker;
...
import com.rupan3th.manualcamerax.ui.camera.views.viewfinder.SurfaceViewOverViewfinder;
...
public class CameraFragment extends Fragment implements BaseActivity.BackPressedListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        settingsManager = ManualCameraX.getInstance(activity).getSettingsManager();
    ...
    public void onViewCreated(@NonNull final View view, Bundle savedInstanceState) {
        ...
        ManualCameraX.setCaptureController(captureController);
    ...
    public void onResume() {
        super.onResume();
        mSwipe.init();
        ManualCameraX.getGyro().register();
        ManualCameraX.getGravity().register();
        updateSettingsBar();
        this.mCameraUIView.refresh(CaptureController.isProcessing);
    ...
    @Override
    public void onPause() {
        ManualCameraX.getGravity().unregister();
        ManualCameraX.getGyro().unregister();
        ManualCameraX.getSettings().saveID();
...
//        Log.d(TAG, "onDestroy() called");
        ...
        ManualCameraX.setCaptureController(captureController = null);
...
//            stringMap.put("ISO_CR", String.valueOf(result.get(CaptureResult.SENSOR_SENSITIVITY)));
                stringMap.put("Shakiness", String.valueOf(ManualCameraX.getGyro().getShakiness()));
                stringMap.put("TripodShakiness", String.valueOf(ManualCameraX.getGyro().tripodShakiness));
                stringMap.put("Tripod", String.valueOf(ManualCameraX.getGyro().getTripod()));
