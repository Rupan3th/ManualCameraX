package com.rupan3th.manualcamerax.ui.camera.views;
...
import com.rupan3th.manualcamerax.ui.camera.binding.CustomBinding;
...
public class AuxButtonsLayout extends LinearLayout {
    ...
    public AuxButtonsLayout(Context context, @Nullable AttributeSet attrs) {
        ...
        buttonParams = new LayoutParams(size, size);
    ...
    private void setListenerAndSelected(String activeId) {
        OnClickListener auxButtonListener = this::onAuxButtonClick;
